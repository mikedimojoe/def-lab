      ...
      {noData ? (
        ...
        <>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap", alignItems: "flex-start" }}>
            {/* D&D breakdown */}
            {detail && (
              <div style={{ flex: 2, minWidth: 280, background: "var(--surface)",
                ...
                <div style={{ marginTop: 14 }}>
                  <h3 style={{ ...panelTitle, marginTop: 0 }}>Run / Pass</h3>
                  <RunPassBar rows={detail.chartRows} />
                </div>
              </div>
            )}
            ...
            <div style={{ minWidth: 160, background: "var(--surface)",
              ...
              <div style={{ width: "100%", marginTop: 8 }}>
                {allPersonnel.slice(0, 8).map((p, i) => (
